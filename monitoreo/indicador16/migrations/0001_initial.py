...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indicador16_ahorropregunta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('indicador16', ['AhorroPregunta'])

        # Adding model 'Ahorro'
        db.create_table('indicador16_ahorro', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('indicador16', ['Ahorro'])


    def backwards(self, orm):
        
        # Deleting model 'AhorroPregunta'
        db.delete_table('indicador16_ahorropregunta')

        # Deleting model 'Ahorro'
        db.delete_table('indicador16_ahorro')

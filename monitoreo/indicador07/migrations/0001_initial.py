...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indicador07_actividad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('indicador07', ['Actividad'])

        # Adding model 'Reforestacion'
        db.create_table('indicador07_reforestacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('indicador07', ['Reforestacion'])


    def backwards(self, orm):
        
        # Deleting model 'Actividad'
        db.delete_table('indicador07_actividad')

        # Deleting model 'Reforestacion'
        db.delete_table('indicador07_reforestacion')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IngresoFamiliar.cantidad'
        db.alter_column('indicador13_ingresofamiliar', 'cantidad', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'IngresoFamiliar.precio'
        db.alter_column('indicador13_ingresofamiliar', 'precio', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'IngresoFamiliar.cantidad'
        db.alter_column('indicador13_ingresofamiliar', 'cantidad', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'IngresoFamiliar.precio'
        db.alter_column('indicador13_ingresofamiliar', 'precio', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'indicador13.ingresofamiliar': {
            ...
            'rubro': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['indicador13.Rubros']"})
        },
        'indicador13.rubros': {

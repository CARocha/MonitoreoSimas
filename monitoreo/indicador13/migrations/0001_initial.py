...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rubros'
        db.create_table('indicador13_rubros', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('indicador13', ['Rubros'])

        # Adding model 'IngresoFamiliar'
        db.create_table('indicador13_ingresofamiliar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('precio', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('indicador13', ['IngresoFamiliar'])


    def backwards(self, orm):
        
        # Deleting model 'Rubros'
        db.delete_table('indicador13_rubros')

        # Deleting model 'IngresoFamiliar'
        db.delete_table('indicador13_ingresofamiliar')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rubros.categoria'
        db.add_column('indicador13_rubros', 'categoria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rubros.categoria'
        db.delete_column('indicador13_rubros', 'categoria')

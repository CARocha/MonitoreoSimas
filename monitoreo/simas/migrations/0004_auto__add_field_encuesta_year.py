...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.year'
        db.add_column('simas_encuesta', 'year', self.gf('django.db.models.fields.IntegerField')(default=2010), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.year'
        db.delete_column('simas_encuesta', 'year')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Encuesta.organizacion_2'
        db.delete_column('simas_encuesta', 'organizacion_2_id')


    def backwards(self, orm):
        
        # Adding field 'Encuesta.organizacion_2'
        db.add_column('simas_encuesta', 'organizacion_2', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['simas.Organizaciones']), keep_default=False)

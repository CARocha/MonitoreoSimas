...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizaciones.descripcion'
        db.add_column('simas_organizaciones', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Organizaciones.zona'
        db.add_column('simas_organizaciones', 'zona', self.gf('django.db.models.fields.IntegerField')(default='1'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizaciones.descripcion'
        db.delete_column('simas_organizaciones', 'descripcion')

        # Deleting field 'Organizaciones.zona'
        db.delete_column('simas_organizaciones', 'zona')

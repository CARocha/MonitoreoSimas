...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Migrando de Foreign key a Many To Many"

        
        print "renombrando columna temporal"
        db.rename_column('simas_encuesta', 'organizacion_id', 'organizacion_2_id')
        print "creando tabla intermedia"
        db.create_table('simas_encuesta_organizacion', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organizaciones', models.ForeignKey(orm['simas.Organizaciones'], null=False)),
            ('encuesta', models.ForeignKey(orm['simas.Encuesta'], null=False))
        ))
        db.create_unique('simas_encuesta_organizacion', ['organizaciones_id', 'encuesta_id'])

        print "agregando columna temporal"
        
        print "brujuleo de pasar cosas"
        for encuesta in orm.Encuesta.objects.all():
            encuesta.organizacion.add(encuesta.organizacion_2)
            encuesta.save()

        print "borrando columna y listo :D"
        db.delete_column('simas_encuesta', 'organizacion_2_id')

    def backwards(self, orm):
        "Write your backwards methods here."
        raise Exception("migracion hacia atras no soportada") 
    ...
    models = {
        ...
        'simas.encuesta': {
            ...
            'organizacion_2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['simas.Organizaciones']"}),
            'organizacion': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['simas.Organizaciones']"}),

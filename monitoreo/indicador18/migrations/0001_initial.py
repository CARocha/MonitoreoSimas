...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indicador18_alimentos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('indicador18', ['Alimentos'])

        # Adding model 'Seguridad'
        db.create_table('indicador18_seguridad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('indicador18', ['Seguridad'])


    def backwards(self, orm):
        
        # Deleting model 'Alimentos'
        db.delete_table('indicador18_alimentos')

        # Deleting model 'Seguridad'
        db.delete_table('indicador18_seguridad')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indicador11_cultivosvariedad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cultivo', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('indicador11', ['CultivosVariedad'])

        # Adding model 'Variedades'
        db.create_table('indicador11_variedades', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('indicador11', ['Variedades'])

        # Adding model 'Semilla'
        db.create_table('indicador11_semilla', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('indicador11', ['Semilla'])


    def backwards(self, orm):
        
        # Deleting model 'CultivosVariedad'
        db.delete_table('indicador11_cultivosvariedad')

        # Deleting model 'Variedades'
        db.delete_table('indicador11_variedades')

        # Deleting model 'Semilla'
        db.delete_table('indicador11_semilla')


    models = {
        'indicador11.cultivosvariedad': {
        ...
        'indicador11.semilla': {
            ...
            'cultivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['indicador11.Variedades']"}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['simas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origen': ('django.db.models.fields.IntegerField', [], {})
        },
        'indicador11.variedades': {
            'Meta': {'object_name': 'Variedades'},
            'cultivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['indicador11.CultivosVariedad']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

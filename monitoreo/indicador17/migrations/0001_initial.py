...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indicador17_dacredito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('indicador17', ['DaCredito'])

        # Adding model 'OcupaCredito'
        db.create_table('indicador17_ocupacredito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('indicador17', ['OcupaCredito'])

        # Adding model 'Credito'
        db.create_table('indicador17_credito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('indicador17', ['Credito'])

        # Adding M2M table for field quien_credito on 'Credito'
        db.create_table('indicador17_credito_quien_credito', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('credito', models.ForeignKey(orm['indicador17.credito'], null=False)),
            ('dacredito', models.ForeignKey(orm['indicador17.dacredito'], null=False))
        ))
        db.create_unique('indicador17_credito_quien_credito', ['credito_id', 'dacredito_id'])

        # Adding M2M table for field ocupa_credito on 'Credito'
        db.create_table('indicador17_credito_ocupa_credito', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('credito', models.ForeignKey(orm['indicador17.credito'], null=False)),
            ('ocupacredito', models.ForeignKey(orm['indicador17.ocupacredito'], null=False))
        ))
        db.create_unique('indicador17_credito_ocupa_credito', ['credito_id', 'ocupacredito_id'])


    def backwards(self, orm):
        
        # Deleting model 'DaCredito'
        db.delete_table('indicador17_dacredito')

        # Deleting model 'OcupaCredito'
        db.delete_table('indicador17_ocupacredito')

        # Deleting model 'Credito'
        db.delete_table('indicador17_credito')

        # Removing M2M table for field quien_credito on 'Credito'
        db.delete_table('indicador17_credito_quien_credito')

        # Removing M2M table for field ocupa_credito on 'Credito'
        db.delete_table('indicador17_credito_ocupa_credito')
    ...
    models = {
        'indicador17.credito': {
            ...
            'ocupa_credito': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['indicador17.OcupaCredito']", 'null': 'True', 'blank': 'True'}),
            'quien_credito': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['indicador17.DaCredito']", 'null': 'True', 'blank': 'True'}),
        ...
        'indicador17.dacredito': {
            'Meta': {'object_name': 'DaCredito'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'indicador17.ocupacredito': {
